...
document.body.innerHTML = ''
  ...
  + '<a id="chatcontrol-expand"  accesskey="0" title="[0]"><span class="toggle expand"></span></a>'
  + '<a id="chatcontrol-all"     accesskey="1" title="[1]">all</a>'
  + '<a id="chatcontrol-faction" accesskey="2" title="[2]" class="active">faction</a>'
  + '<a id="chatcontrol-alerts"  accesskey="3" title="[3]">alerts</a>'
  + '</div>'
